	...
	<body class="anim-fadeInUp">
		<div style="margin: 10px;">
			...
			<form id="saveForm" class="layui-form layui-form-pane mt20" >
				...
				<div class="layui-form-item">
					<button class="layui-btn fr" style="float:right;" lay-submit="" lay-filter="demo2">确认修改</button>
				</div>
			</form>
		</div>
			...
			layui.use(['form','laypage','layer','laydate'],function(){
                ...
                form.verify({
                    oldPassword: function(value){
                        ...
                        var data = $.getJSON("/user/validationPwd?pwd=" + value +"&_=" + new Date(),function(d){
							return d;
						});
