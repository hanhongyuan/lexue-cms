...
public class ScheduleJob extends QuartzJobBean {
	...
	protected void executeInternal(JobExecutionContext context) throws JobExecutionException {
		JSONObject json = JSONObject.fromObject(context.getMergedJobDataMap().get(Schedule.JOB_PARAM_KEY));
		...
		Schedule scheduleJob = (Schedule) JSONObject.toBean(json, Schedule.class);
		// 任务开始时间
