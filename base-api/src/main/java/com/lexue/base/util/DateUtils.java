...
public class DateUtils {
	...
	/**
	 *
	 * 获取当前系统时间(返回日期格式yyyyMMddHHmmssS)
	 *
	 * */
	public static String getCurrentTimeToStr(){
		return getDateToFormat(new Date(),DATE_FORMAT_STR2);
	}
	...
	public static String timestamp2Str(long timestamp, String dataFormat)
			throws ParseException {
		if (StringUtils.isEmpty(dataFormat)) {
			dataFormat = "yyyy-MM-dd HH:mm:ss";
		}
		SimpleDateFormat dateFormatGmt = new SimpleDateFormat(dataFormat);
		return dateFormatGmt.format(new Date(timestamp));
	}
	/**
	 * 字符串转换成日期格式
	 * @param dateStr 日期字符串
	...
	public static Long strConvertToLong(String dateStr) {
		SimpleDateFormat sdf = new SimpleDateFormat(DATE_FORMAT_STR7);
		Date date = null;
		try {
			date = sdf.parse(dateStr);
		} catch (ParseException e) {
	...
	public static Date string2Date(String time,String dataFormat) {
	...
	public static String formatLongToString(Long date){
		...
		return getDateToFormat(d,DATE_FORMAT_STR7);
	}
	public static void main(String [] str){
		System.out.print(formatLongToString(1503382978546L));
	}
}
